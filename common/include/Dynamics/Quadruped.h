...
class Quadruped {
 public:
  ...
  RobotType _robotType;
    ...
    T _abadLinkLength, _hipLinkLength, _kneeLinkLength, _kneeLinkY_offset, _maxLegLength, _abadRotorLocationXOffset, _hipRotorLocationYOffset, _kneeRotorLocationYOffset;
