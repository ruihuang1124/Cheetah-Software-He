#ifndef FOLLOW_TRAJECTORY_CONTROLLER
#define FOLLOW_TRAJECTORY_CONTROLLER

#include <RobotController.h>
#include "Controllers/FootSwingTrajectory.h"
#include <deque>
#include "../Imitation_Controller/ImitationUserParameters.h"
#include <mutex>
#include <thread>
...
using std::deque;
class Follow_Trajectory_Controller : public RobotController
{
public:
...
private:
    ...
    bool finish_trajectory_following;
};
